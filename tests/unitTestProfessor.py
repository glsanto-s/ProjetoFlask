...
class TestProfessorMetodos(unittest.TestCase):
    def test_000_professor_retorna_lista(self):
        res = requests.get('http://127.0.0.1:8000/professores')
    ...
    def test_001_professor_por_id_encontrado(self):
        idProfessor = 13
        res = requests.get(f'http://127.0.0.1:8000/professor/{idProfessor}')
    ...
    def test_004_professor_adicionar_sucesso(self):
        ...
        res = requests.post('http://127.0.0.1:8000/professor', data=data)
    ...
    def test_005_professor_alterar_pagina_sucesso(self):
        idProfessor = 6
        res = requests.post(f'http://127.0.0.1:8000/professor/{idProfessor}/alterar')
    ...
    def test_007_professor_alterar_sucesso(self):
        ...
        idProfessor = 6
        res = requests.post(f'http://127.0.0.1:8000/professor/{idProfessor}', data=data)
    ...
    def test_008_professor_alterar_nao_encontrado(self):
        ...
        idProfessor = 756
        res = requests.put(f'http://127.0.0.1:8000/professor/{idProfessor}', data=data)
        self.assertEqual(res.status_code, 404, "Deveria retornar 404 quando professor não é encontrado")
    ...
    def test_009_professor_deletar_sucesso(self):
        idProfessor = 17
        res = requests.post(f'http://127.0.0.1:8000/professor/deletar/{idProfessor}')
    ...
    def test_010_professor_deletar_nao_encontrado(self):
        id_professor = 963
        response = requests.delete(f'http://127.0.0.1:8000/professor/deletar/{id_professor}')
